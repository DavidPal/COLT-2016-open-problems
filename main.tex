...
\norm{x}_1 = 1\}$ and the Hilbert space. OLO over
...
even for one-dimensional Hilbert space $\H = \R$. Also, the reductions in \cite{Orabona-Pal-2016-parameter-free} might imply that solving the one-dimensional gives also the general Hilbert space and the LEA cases.
